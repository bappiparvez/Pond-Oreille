...
public class BPTrend{
    ...
    public static void main(String[] args) {
        ...
        from = "2012/02/01 00:30:00";
        to = "2012/02/01 02:30:00";

        System.out.println( calcTrend.doCalc( from, to ) );

        System.out.println("Test Case #2:");

        from = "2013/06/15 10:30:00";
        to = "2013/06/17 02:30:00";

        System.out.println( calcTrend.doCalc( from, to ) );

        System.out.println("Test Case #3:");

        from = "2014/11/21 10:00:00";
        to = "2014/11/25 23:59:59";
